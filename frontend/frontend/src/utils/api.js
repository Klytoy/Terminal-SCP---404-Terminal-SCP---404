...
// Custom Clearances
export const getCustomClearances = () => api.get('/admin/custom-clearances');
export const createCustomClearance = (data) => api.post('/admin/custom-clearances', data);
export const updateCustomClearance = (id, data) => api.patch(`/admin/custom-clearances/${id}`, data);
export const deleteCustomClearance = (id) => api.delete(`/admin/custom-clearances/${id}`);
export const assignCustomClearance = (id, userId) => api.post(`/admin/custom-clearances/${id}/assign`, { userId });
export const unassignCustomClearance = (id, userId) => api.post(`/admin/custom-clearances/${id}/unassign`, { userId });
